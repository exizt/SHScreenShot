...
namespace Image_Capture
{
    class HFilePath
    {
        ...
        public static string PathDialog()
        {
            ...
            _saveFD.Filter = "이미지 파일 (*.jpg)|*.jpg|비트맵파일 (*.bmp)|*.bmp|모든 파일 (*.*)|*.*";//확장자 선택
        ...
        public static void Save(string dir_path, System.Drawing.Image image)
        {
            if (dir_path != "")
            {
                if (image != null)
                {
                    image.Save(dir_path, System.Drawing.Imaging.ImageFormat.Jpeg);
        ...
        public void Save(System.Drawing.Image _image)
        {
            ...
            {
                HFilePath.Save(HFilePath.PathDialog(), _image);//파일저장
            }
        }
